package am.ak.microservice.example.order.controller;

import am.ak.microservice.example.order.dto.OrderRequest;
import am.ak.microservice.example.order.service.OrderService;
...
public class OrderController {
    ...
    public CompletableFuture<String> fallbackMethod(OrderRequest orderRequest, RuntimeException ex) {
        return CompletableFuture.supplyAsync(() -> "Something was wrong please try later");
    }
}
